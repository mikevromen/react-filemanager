...
import { setVisibleDialogOpenUrl } from '../../../Actions/Actions.js';
        ...
        return (
          <div style={{marginLeft:'1em'}}>
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-content" fullWidth={true} maxWidth={'sm'}>
              <DialogTitle id="form-dialog-content">Open url </DialogTitle>
              <DialogContent>
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        handleClose: (event) => {
            dispatch(setVisibleDialogOpenUrl(false));
        },
        handleOpen: (event) => {
            dispatch(setVisibleDialogOpenUrl(true));
        },
    };
};
